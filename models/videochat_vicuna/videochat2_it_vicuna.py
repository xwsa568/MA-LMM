...
@registry.register_model("VideoChat2_malmm")
class VideoChat2_it_vicuna(Blip2Base):
    PRETRAINED_MODEL_CONFIG_DICT = {
        "vicuna7b": "configs/config.yaml",
    }
    """
    VideoChat2 model.
    """
    def __init__(self, config):
        ...
        memory_bank_length=config.get("memory_bank_length", 20)
        ...
        self.qformer, self.query_tokens = self.init_Qformer(
            num_query_token, config.vision_encoder.encoder_embed_dim, memory_bank_length, num_frames,
